	...
	public function show_pro_infos(): void {
		...
		?>
			<ul>
				...
				<li><?php echo esc_html__( 'Native support for following PageBuilders: Avada, Beaver Builder, Bricks, Brizy, Divi 4 & 5, Elementor, Elements in GeneratePress Premium, SiteOrigin (SiteOrigin Widgets Bundle necessary), WPBakery', 'personio-integration-light' ); ?></li>
