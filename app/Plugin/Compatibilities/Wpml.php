<?php
/**
 * File to handle the compatibility-check for WPML.
 *
 ...
 */
class Wpml extends Compatibilities_Base {
	 ...
	 * @var string
	 */
	protected string $name = 'personio_integration_compatibility_wpml';
	 ...
	 * @var ?Wpml
	 */
	private static ?Wpml $instance = null;

	/**
	 * Return the instance of this Singleton object.
	 */
	public static function get_instance(): Wpml {
	...
	public function check(): void {
		...
		if ( $this->is_active() ) {
			...
			$transient_obj->set_message( sprintf( __( '<strong>We realized that you are using WPML for multiple languages in your website - very nice!</strong> <a href="%1$s" target="_blank"><i>Personio Integration Pro</i> (opens a new window)</a> supports the multilingualism of open positions via WPML.', 'personio-integration-light' ), esc_url( Helper::get_pro_url() ) ) );
