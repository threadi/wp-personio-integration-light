<?php
/**
 * File to handle the compatibility-check for Pods.
 *
 ...
 */
class Pods extends Compatibilities_Base {
	 ...
	 * @var ?Pods
	 */
	private static ?Pods $instance = null;

	/**
	 * Return the instance of this Singleton object.
	 */
	public static function get_instance(): Pods {
	...
	public function check(): void {
		...
		if ( $this->is_active() ) {
			...
			$transient_obj->set_message( sprintf( __( '<strong>We realized that you are using Pods - very nice!</strong> <a href="%1$s" target="_blank"><i>Personio Integration Pro</i> (opens a new window)</a> allows you to extend the data of your positions with Pods.', 'personio-integration-light' ), esc_url( Helper::get_pro_url() ) ) );
	...
	public function is_active(): bool {
		return Helper::is_plugin_active( 'pods/init.php' );
	}
}
