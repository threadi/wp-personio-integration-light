...
class MetForm extends Compatibilities_Base {
	...
	public function check(): void {
		...
		if ( $this->is_active() ) {
			...
			$transient_obj->set_message( sprintf( __( '<strong>We realized that you are using MetForm - very nice!</strong> Send us a request if you want to collect your applications with this form plugin using our <a href="%1$s" target="_blank"><i>Personio Integration Pro</i> (opens a new window)</a>.', 'personio-integration-light' ), esc_url( Helper::get_pro_url() ) ) );
