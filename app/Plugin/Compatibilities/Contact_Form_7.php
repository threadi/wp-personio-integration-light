...
class Contact_Form_7 extends Compatibilities_Base {
	...
	public function check(): void {
		...
		if ( $this->is_active() ) {
			...
			$transient_obj->set_message( sprintf( __( 'We realized that you are using Contact Form 7 - very nice! <a href="%1$s" target="_blank"><i>Personio Integration Pro</i> (opens a new window)</a> allows you to design your application forms with Contact Form 7.', 'personio-integration-light' ), esc_url( Helper::get_pro_url() ) ) );
