...
class Settings_Import {
	...
	public function show_button(): void {
		...
		// output button.
		?>
		<a href="" class="button button-primary easy-dialog" data-dialog="<?php echo esc_attr( wp_json_encode( $dialog ) ); ?>"><?php echo esc_html__( 'Import settings', 'personion-integration-light' ); ?></a>
		<?php
	}
