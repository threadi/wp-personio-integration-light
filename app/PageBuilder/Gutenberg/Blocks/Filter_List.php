...
class Filter_List extends Blocks_Basis {
	...
	public function render( array $attributes ): string {
		 ...
		 */
		return \PersonioIntegrationLight\PersonioIntegration\Widgets\Filter_List::get_instance()->render( apply_filters( 'personio_integration_get_list_attributes', $attribute_defaults, $attributes ) );
	}
}
