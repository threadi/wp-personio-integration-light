...
function personio_integration_settings_add_template_tab( $tab ): void
{
    ...
    // output tab
    echo '<a href="?post_type='.WP_PERSONIO_INTEGRATION_CPT.'&page=personioPositions&tab=template" class="nav-tab'.$activeClass.'">'._x('Templates', 'wp-personio-integration').'</a>';
}
