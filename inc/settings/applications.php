...
function personio_integration_settings_add_applications_readonly_tab(): void {
	// output tab.
	echo '<span class="nav-tab" title="' . esc_attr__( 'Only in Pro.', 'personio-integration-light' ) . '">' . esc_html__( 'Applications', 'personio-integration-light' ) . ' <span class="pro-marker">Pro</span></span>';
}
