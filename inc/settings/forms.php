...
{
	// output tab.
	echo '<span class="nav-tab" title="'.__('Only in Pro.', 'personio-integration-light').'">'.__('Application Forms', 'personio-integration-light').' <span class="pro-marker">Pro</span></span>';
}
