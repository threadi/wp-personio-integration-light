...
if( $wpQueryResults->have_posts() ) :
    while ( $wpQueryResults->have_posts() ) : $wpQueryResults->the_post();
        ...
        ?>
            <article id="post-<?php echo $position->ID; ?>" class="site-main post-<?php echo $position->ID; ?> <?php echo get_post_type($position->ID); ?> type-<?php echo get_post_type($position->ID); ?> status-<?php echo get_post_status($position->ID); ?> entry">
                <?php
